...
console.log("-- proxy-server master ", process.argv[1]);
...
(function (global, module, undefined) {
    ...
    (function () {
        ...
        console.log("spawn: ", path.join(path.dirname(module.filename), "./http-proxy.js"));
        ...
        //Listen
        if (options.port) {
            console.log("clusterObject.listen(" + options.port + ", \"" + options.host + "\");");
