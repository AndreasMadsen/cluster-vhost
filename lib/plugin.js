        ...
        return function (master) {
            ...
            if (master.isWorker && config.transparantProxy === true) {
                ...
                (function () {
                    ...
                    console.log("vhost plugin active on worker");
            ...
            //If this is the master - send vhost infomation
                ...
                (function () {
                    ...
                    console.log("vhost plugin active on master");
                    ...
                    sendVhostData = function () {
                        ...
                        ["http", "https"].forEach(function (name) {
                            ...
                            if (config[name] !== false) {
                                ...
                                var vhostMsg = JSON.stringify([{ "port" : master.port, "host" : master.host || "localhost", "vhost" : vhostname}]),
